  ...
  void check() {
    setState(() {
      added = CartManager.existsInCart(
          CartProduct(widget.item, widget.item.selectedPricing));
    });
    print(added);
  }
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                          widget.item.selectedPricing.price != 0
                              ? widget.item.selectedPricing.price.toString()
                              : 'null',
                          style: TextStyle(
